package ro.amadeux.jwebt.utils;
...
//Copiamos el código de: (los imports también, cambiando @Service por @Component)
...
//Esta clase genera el JWT (JsonWebToken)
//Valida el JWT
//Comprueba cuando expira el JWT
@Component
